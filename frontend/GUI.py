...
old_chat_messages = ""
GraphicsDirePath = rf"{current_dir}\Frontend\Graphics"


import os

def TempDirectoryPath(filename):
    """Returns the full path of the file inside the temp directory."""
    script_dir = os.path.dirname(os.path.abspath(__file__))  # Get current script directory
    temp_dir = os.path.join(script_dir, "Files")  # Ensure it points to `E:\jarvis\frontend\Files`
...
def GraphicsDirectoryPath(Filename):
    return os.path.join(GraphicsDirePath, Filename)


def FixedTempDirectoryPath(Filename):
    Path = rf'{TempDirectoryPath(Filename)}'
    return Path
